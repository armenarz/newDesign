                ...
                <div class="row">
                    <div class="col-lg-2">
                        <nav class="nav navbar-white bg-white flex-column d-print-none" id="toolbars">
                            <a class="nav-link disabled border-bottom active border-top" href="#" data-toggle="modal" data-target="#calendarModalWindow" id="calendarLink"><i class="far fa-calendar-alt"></i>&nbsp;Календарь</a>
                            ...
                            <a class="nav-link disabled border-bottom" href="#" data-toggle="modal" data-target="#copyModalWindow" id="copyLink"><i class="far fa-copy"></i>&nbsp;Копировать</a>
