                    ...
                    $sql1 ="    SELECT 
                                ...
                                (
                                    (
                                        ...
                                        (
                                            doctor 
                                            INNER JOIN orders ON doctor.DoctorId = orders.DoctorId
                                        )
                                        ON orderresult.OrderId = orders.OrderId
                                    ) 
...
header("Content-Disposition: attachement; filename=doctors13Consolidated.xls");
echo $msg;
?>