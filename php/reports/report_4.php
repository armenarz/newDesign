                ...
                <div class="row">
                    <div class="col-lg-2">
                        <nav class="nav navbar-white bg-white flex-column d-print-none" id="sidebar">
                            ...
                            <a class="nav-link border-bottom" href="#" data-toggle="modal" data-target="#reagentExpensesModalWindow" id="reagentExpensesLink"><i class="far fa-file-alt"></i>&nbsp;Расход&nbsp;реагентов</a><!--active -->
