...
if($menuId == "doctor13Link" && $reportTypeId == 2)
{
	...
	$msg.= '
	<table class="table" border="1" id="doctor13Data">
		<caption>
            <h2>Врач13</h2>
	...
	for($i = 0; $i < COUNT($array_workplace_totals); $i++)
	{
		...
		$msg.= '<tr>
					<td scope="col" colspan="9"><strong>'.$current_workplace_desc.' [ id: '.$current_workplace_id.' ] </strong></td>
				</tr>';
...
header("Content-Disposition: attachement; filename=doctors13Detailed.xls");
echo $msg;
?>